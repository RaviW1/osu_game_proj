...
public class BaldurBoss : ISprite, IEnemy
{
    ...
    public BaldurBoss(Texture2D texture, Vector2 startPos, Texture2D firballText)
    {
    ...
    public void ChangeState(IBaldurState newState)
    {
    ...
    public void Die()
    {
        if (isDead) return;
        isDead = true;
        ChangeState(new BaldurDeathState());
